...
const text = "MAMOON KHAN"; // Text to display
const typeSpeed = 120; // Typing speed in milliseconds
const delaySpeed = 80; // Delay between typing and resetting in milliseconds
...
function type() {
  ...
  // Add cursor style if typing is not complete
  ...
  // Continue typing if not at the end of the text
  if (charIndex <= fullText.length) {
